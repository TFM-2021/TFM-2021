...
VAL_incendios <- read.csv('data/data_VAL/VAL_incendios_EVT_clusters_clara.csv') 

VAL_incendios <- VAL_incendios[,-1]

VAL_incendios <- VAL_incendios[,c(1, 9, 10, 12)]
...
k_folds_data <- vfold_cv(train_data, strata = superficie,v = 10)
